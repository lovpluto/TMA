var animation = lottie.loadAnimation({
    ...
    loop: true,
    autoplay: true,
    path: '../export/fullAnimateForWeb.json' // the path to the animation json
  });
var animation1 = lottie.loadAnimation({
    ...
    loop: true,
    autoplay: true,
    path: '../export/tmaLogoFirst.json' // the path to the animation json
  });
var animation2 = lottie.loadAnimation({
    ...
    loop: true,
    autoplay: true,
    path: '../export/tmaLogoSecond.json' // the path to the animation json
  });
var animation3 = lottie.loadAnimation({
    ...
    loop: true,
    autoplay: true,
    path: '../export/tmaLogoThird.json' // the path to the animation json
  });
var animation4 = lottie.loadAnimation({
    ...
    loop: true,
    autoplay: true,
    path: '../export/tmaLogoFour.json' // the path to the animation json
  });
var animation5 = lottie.loadAnimation({
    ...
    loop: true,
    autoplay: true,
    path: '../export/tmaLogoFive.json' // the path to the animation json
  });
